 ...
 */
App::import('Datasource', 'Datasources.DboSqlite3');
 ...
 */
class DboSqliteTestDb extends DboSqlite3 {
 ...
 */
	function skip() {
		$this->_initDb();
		$this->skipUnless($this->db->config['driver'] == 'Datasources.DboSqlite3', '%s SQLite connection not available');
	}
	...
	function testDescribe() {
		...
		$expected = array(
			...
			'created' => array(
				'type' => 'datetime',
				'null' => true,
				//'default' => null,  FIXME: sqlite3 simply returns NULL in desc
			    'default' => 'NULL',
				'length' => null,
			),
			'updated' => array(
